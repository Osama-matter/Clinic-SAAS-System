...
const DoctorSchedulePage = () => {
  ...
  const saveNote = async (id) => {
    try {
      await appointmentService.updateStatus(id, { notes: tempNote });
  ...
  const statusMap = {
    0: { label: t('statusPending'), color: "bg-amber-500/10 text-amber-400 border-amber-500/20" },
    1: { label: t('statusConfirmed'), color: "bg-emerald-500/10 text-emerald-400 border-emerald-500/20" },
    2: { label: t('statusCancelled'), color: "bg-rose-500/10 text-rose-400 border-rose-500/20" },
    3: { label: t('statusRescheduled'), color: "bg-blue-500/10 text-blue-400 border-blue-500/20" },
                    ...
                    <div className="flex flex-wrap justify-between items-start gap-6 mb-8">
                      <div className="space-y-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h3 className="text-xl font-black text-on-surface">{a.patientName || (isAr ? "مريض مجهول" : "Unknown Patient")}</h3>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {(isDoctor || isAdmin) && (
                            ...
                            >
                              ...
                              <option value="4">{t('statusCompleted')}</option>
