...
const DrawerShell = ({ open, onClose, children }) => (
  <div className={`fixed inset-0 z-[95] ${open ? "" : "pointer-events-none"}`}>
    ...
    />
    <div
      className={`absolute top-0 right-0 h-full w-full sm:w-[520px] bg-white border-l border-slate-200 shadow-2xl transition-transform ${open ? "translate-x-0" : "translate-x-full"
        }`}
    >
      {children}
    </div>
            ...
            <>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="rounded-2xl border border-slate-200 bg-white p-4">
                  ...
                  <div className={`mt-2 inline-flex items-center gap-2 px-3 py-2 rounded-xl border text-[10px] font-black uppercase tracking-widest ${derivedInProgress ? "bg-blue-50 text-blue-600 border-blue-200" : "bg-slate-50 text-slate-500 border-slate-200"
                    }`}>
