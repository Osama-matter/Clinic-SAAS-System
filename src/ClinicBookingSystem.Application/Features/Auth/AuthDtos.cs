...
public record UserDto(Guid Id, string Name, string Email, string Role, DateTime CreatedAt, Guid? TenantId = null);

// ── Commands ──────────────────────────────────────────
public record RegisterCommand(string Name, string Email, string Password, Guid? TenantId = null) : IRequest<UserDto>;

public record CreateAdminCommand(string Name, string Email, string Password, Guid? TenantId = null) : IRequest<UserDto>;
